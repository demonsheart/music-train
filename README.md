...
一个免费的 Flutter 音乐训练应用，旨在帮助乐手提升基础音乐理论能力。
...
5. **交互式答案选择** 🎯
   ...
   - 12 个音名选择按钮 (C, C#, D, D#, E, F, F#, G, G#, A, A#, B)
   - 7 个级数选择按钮 (I, II, III, IV, V, VI, VII)
   - 按钮点击动画效果
...
1. 查看当前固定调性 (例如: "C 大调")
2. 查看显示的级数 (例如: "I")
3. 从下方 12 个音名按钮中选择正确答案
4. 系统会在按钮内实时反馈答案是否正确
5. **答对时**：选择按钮显示绿色勾号
6. **答错时**：选择按钮显示红色叉号，同时正确答案按钮显示琥珀色灯泡
7. 1.5 秒后自动生成下一题（继续在相同调性下练习）

#### 反向练习模式 (音名 → 级数)

1. 查看当前固定调性 (例如: "G 小调")
2. 查看显示的音名 (例如: "D#")
3. 从下方 7 个级数按钮中选择正确答案
4. 系统会在按钮内实时反馈答案是否正确
5. **答对时**：选择按钮显示绿色勾号
6. **答错时**：选择按钮显示红色叉号，同时正确答案按钮显示琥珀色灯泡
7. 1.5 秒后自动生成下一题（继续在相同调性下练习）
...
1. **正向练习测试**: 在 C 大调下，级数 I 应该对应音名 C
2. **反向练习测试**: 在 A 小调下，音名 C 应该对应级数 III
